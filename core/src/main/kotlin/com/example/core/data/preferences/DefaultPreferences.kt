...
class DefaultPreferences(
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        return UserInfo(
            gender = Gender.fromString(gender ?: Gender.MALE),
            age = age,
            weight = weight,
            height = height,
            activityLevel = ActivityLevel.fromString(activityLevel ?: ActivityLevel.MEDIUM),
            goalType = GoalType.fromString(goalType ?: GoalType.KEEP_WEIGHT),
            carbRatio = carbRatio,
    ...
    override fun loafShouldShowOnboarding(): Boolean {
